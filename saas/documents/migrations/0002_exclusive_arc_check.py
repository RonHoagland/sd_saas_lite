...
on documents_document. Per Note & Document Implementation Specification
V1 §3.2, exactly one parent FK must be non-null.
...
a Document with zero or two+ parents.
...
_TABLE = 'documents_document'
_CONSTRAINT = 'documents_document_exclusive_parent_arc'
