...
class SeedDataIntegrityTest(SDTATestCase):
    ...
    def test_value_lists_count(self):
        """11 value lists should be defined."""
        self.assertEqual(len(VALUE_LISTS), 11)
...
class SeedValueListsTest(SDTATestCase):
    ...
    def test_creates_lists(self):
        ...
        self.assertEqual(result['lists'], 11)
        self.assertEqual(
            ValueList.all_objects.filter(tenant_id=self.tenant_id).count(), 11
        )
...
class SeedTenantIntegrationTest(SDTATestCase):
    ...
    def test_seed_tenant_returns_counts(self):
        ...
        self.assertEqual(counts['value_lists']['lists'], 11)
