...
> **Compatibility:** Designed to synchronize with ServizmaDesk Lite MVP V4 Specification and Product Tier Map V2.
...
Plan limits (seats, storage, features) are defined in **ServizmaDesk Product Tier Map V2**.

Pricing for all tiers is defined in **ServizmaDesk Pricing & Billing Specification V2**.

For complete plan limits, see:
→ **ServizmaDesk Product Tier Map V2, Section 6**

For complete pricing details, see:
→ **ServizmaDesk Pricing & Billing Specification V2, Section 3**

---

## 5.3 Billing Cycles

Customers choose between monthly and annual billing at signup. Billing cycle rules, pricing, and switching behavior are defined in **ServizmaDesk Pricing & Billing Specification V2, Section 3.2**.
...
→ **ServizmaDesk Pricing & Billing Specification V2, Section 3.2**
...
ServizmaDesk uses per-seat subscription billing with both monthly and annual options. Complete billing model details, pricing, and seat counting rules are defined in **ServizmaDesk Pricing & Billing Specification V2, Section 3**.
...
Seat billing rules and seat counting logic are defined in **ServizmaDesk Pricing & Billing Specification V2, Section 3.3**.
...
→ **ServizmaDesk Pricing & Billing Specification V2, Section 3.3**

---

## 6.5 Storage Add-On Billing

Storage add-on pricing and limits are defined in **ServizmaDesk Pricing & Billing Specification V2, Section 4**.
...
All emails are sent from SDP via **Postmark** (see Section 9.4). All emails use basic HTML templates with ServizmaDesk branding — company name, logo, and consistent styling. Full design templates are deferred to a future version.
...
> **Decision:** Postmark is the designated email provider for **all ServizmaDesk email sending** — both internal SDP communications (Welcome emails, billing alerts, password resets) and tenant-to-customer emails (quotes, invoices, notifications).
> **Tenant-Side Emails:** Tenant-to-customer email sending uses a point-based system (1 point = 1 email). Platform-managed mode sends from ServizmaDesk's domain by default. Custom Domain authentication (emails from tenant's own domain) is a paid add-on available on Pro and Enterprise. BYOS (Bring Your Own SMTP) is not supported. See ServizmaDesk Email Specification V1 and Pricing & Billing Specification V2 Section 10A and 11.4 for full details.
