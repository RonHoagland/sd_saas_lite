...
All pricing, billing cycles, storage add-ons, and Founding Partner program details are defined in the **ServizmaDesk Pricing & Billing Specification V2**.
...
Servizmadesk offers a 14-day free trial with no credit card required. Full trial terms, expiration flow, and conversion process are defined in **ServizmaDesk Pricing & Billing Specification V2, Section 6**.
...
→ **ServizmaDesk Pricing & Billing Specification V2, Section 6**
...
→ **ServizmaDesk Pricing & Billing Specification V2, Section 5**
...
- **System Email:** 400 email points/month. Manual sends only (quote sends, invoice sends, manual customer messages). No automated triggers. Sent via ServizmaDesk's platform domain with the tenant's company name as display sender. See Pricing & Billing Specification V2, Section 10 and 10A.
...
- ServizmaDesk Platform (SDP) V2 Specification — for platform architecture, provisioning, and billing details
- ServizmaDesk Lite MVP V4 Specification — for detailed Lite module specifications
- ServizmaDesk Pricing & Billing Specification V2 — for all pricing, trial, storage, and Founding Partner details
