...
- SDP is not an application feature set — it contains no Work Orders, Invoices, Quotes, Service Items, or any field service operational modules
...
| Price Per Seat         | See Pricing & Billing Specification V2, Section 3.1 |
...
- Pricing defined in ServizmaDesk Pricing & Billing Specification V2, Section 3.1
...
- **Price:** See ServizmaDesk Pricing & Billing Specification V2, Section 3.1
...
### ServizmaDesk Lite (3 GB included)
| Add-On    | Price          |
|-----------|----------------|
| +5 GB     | $3/month       |
| +10 GB    | $5/month       |

> **Note:** Max possible storage: 10 GB.

### ServizmaDesk Plus (10 GB included)
| Add-On    | Price          |
|-----------|----------------|
| +25 GB    | $10/month      |
| +50 GB    | $25/month      |
...
> **Note:** Max possible storage: 75 GB (capped).

### ServizmaDesk Pro (25 GB included)
| Add-On        | Price                                   |
|---------------|-----------------------------------------|
| +50 GB        | $20/month                               |
| +75 GB        | $55/month                               |
| 100 GB to 200 GB | $1 per GB per month (e.g., 135 GB = $135/mo)|
| Beyond 200 GB | $2 per GB per month                     |

> **Note:** Pro has no hard cap — higher storage volumes scale up in price past 200 GB.

### Add-On Billing Behavior
- Storage add-ons are billed as a fixed monthly or annual amount added to the subscription
- Add-ons are added to the Stripe subscription as additional line items
- Proration applies if an add-on is purchased mid-billing period
- Add-ons can be removed from the Billing section in SDTA — removal takes effect at the end of the current billing period
- If storage usage exceeds the new limit after removing an add-on, uploads are blocked until usage is reduced
