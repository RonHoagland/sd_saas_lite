...
- Each team assignment links an Employee to the WorkGroup with a role (e.g., Lead Technician, Helper, Project Manager)
- Roles defined via WGTRole entity (customizable per tenant)
...
- Provides a single place to see every Asset being worked on across the grouped Work Orders
...
- Supports pre-job equipment validation (ensure tools are checked out before dispatch)
...
- **Pricing (Pro/Enterprise)** — Monthly, quarterly, or annual fee per tier
...
- **Asset** — Link to Asset record (required — asset-centric)
...
- Generates Invoices per billing cycle (Pro/Enterprise — via Agreement pricing)
...
**Recurring Invoice Generation (Pro/Enterprise):**
- Auto-generate invoices per Agreement billing cycle
- Billing tied to Agreement pricing tiers
...
**End of ServizmaDesk Top-Down Specifications V3**
